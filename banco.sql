...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stoqja`.`Cidades` (
...
-- -----------------------------------------------------
-- Table `stoqja`.`Funcionario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stoqja`.`Funcionario` (
  ...
  `complemento` VARCHAR(500) NULL DEFAULT NULL,
  ...
  INDEX `FK_FuncionarioCidades_idx` (`FK_idCidade` ASC) VISIBLE,
  CONSTRAINT `FK_Funcionario_Cidades`
...
-- Table `stoqja`.`Pessoa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stoqja`.`Pessoa` (
  `idPessoa` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(200) NOT NULL,
  `cpfCnpj` VARCHAR(18) NOT NULL,
  `nomeFantasia` VARCHAR(200) NULL DEFAULT NULL,
  `telefone` VARCHAR(15) NOT NULL,
  `email` VARCHAR(100) NULL DEFAULT NULL,
  ...
  INDEX `FK_PessoaCidades_idx` (`FK_idCidade` ASC) VISIBLE,
  CONSTRAINT `FK_Pessoa_Cidades`
    FOREIGN KEY (`FK_idCidade`)
    REFERENCES `stoqja`.`Cidades` (`idCidade`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `stoqja`.`Carrinho`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stoqja`.`Carrinho` (
...
CREATE TABLE IF NOT EXISTS `stoqja`.`MovEstoque` (
  ...
  INDEX `FK_MovEstoque_Produto_idx` (`FK_idProduto` ASC) VISIBLE,
